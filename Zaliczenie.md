...
["Biały dom"](whitehouse.geojson "Biały dom")


Znajdź wszystkie najbliższe kody pocztowe w promieniu 50km od Statuy wolności, poczynając od najbliższego brzegu do miasta (pomijając wyspy, odległość 1km wyciągnąłem z google maps).
```sh
...
```
["Statua"](statueofliberty.geojson "Statua")
...
["Floryda"](florida.geojson "Floryda")
